...
- [x] [prj04a: sum_of_odd_numbers](./13-loops/sum_of_odd_nums.cpp)
- [x] [ex16: range_for](./13-loops/range_for.cpp)
- [x] [prj04b: average_temperatures.cpp](./13-loops/avg_temp.cpp)
- [x] [ex17: break-continue](./13-loops/break_continue.cpp)
- [x] [prj04c: rock_paper_scissors_lizard_spock.cpp](./prj04-rock-paper-scissors/main.cpp)
